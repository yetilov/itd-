...
(function() {
    ...
    function generateAdBlockHTML(colors) {
        return `
            <div style="position: fixed; top: 20px; right: 20px; width: 500px; border-radius: 24px; background: rgba(34,25,36,0.8); border: 2px solid ${colors.secondary}; backdrop-filter: blur(12px); padding: 24px; color: white; font-family: Inter, sans-serif; box-sizing: border-box; z-index: 99999; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                    <span style="font-weight: 800; font-size: 24px; color: ${colors.primary};">Телеграм канал автора скрипта</span>
                    <button class="itd-ad-close" style="background: none; border: none; color: ${colors.primary}; font-size: 36px; cursor: pointer; line-height: 1; padding: 0; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">&times;</button>
                </div>
                <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 24px;">
                    <a href="https://t.me/vcb_code" target="_blank" style="color: ${colors.primary}; text-decoration: none; font-weight: 700; font-size: 26px; border-bottom: 2px solid ${colors.primary};">@vcb_code</a>
                    <img src="https://cdn-icons-png.flaticon.com/128/5968/5968804.png" style="width: 36px; height: 36px; vertical-align: middle;" alt="Telegram">
                </div>
                <div style="font-size: 18px; color: rgba(255,255,255,0.5); text-align: right;">Реклама</div>
            </div>
        `;
    }
