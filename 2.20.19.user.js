...
(function() {
    ...
    // ====если эмодзи не работают, пошли они тогда нахуй
    function initEmojiSystem() {
        ...
        const emojiConfig = {
            ...
            imageFormat: 'png',
            excludeSelectors: ['script', 'style', 'textarea', 'input', 'code', 'pre', '.no-emoji', '[data-no-emoji]']
        };
        ...
        emojiList.forEach(emoji => {
            ...
            span.addEventListener('click', () => {
                if (activeEmojiField) {
                    ...
                    setTimeout(() => {
                        if (activeEmojiField && processEmojiDOM) {
                            if (activeEmojiField.isContentEditable) {
                                processEmojiDOM(activeEmojiField.parentNode);
                            } else {
                                processEmojiDOM(activeEmojiField);
                            }
                        }
                    }, 20);
                }
